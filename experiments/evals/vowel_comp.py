...
def get_reference_vowels(tg_path, audio_path):
	"""
...
small_d = dict()
ref_vowels = get_reference_vowels("/Users/Elias/ULD/audio/icicles/icicles.TextGrid", "/Users/Elias/ULD/audio/icicles/icicles.wav")

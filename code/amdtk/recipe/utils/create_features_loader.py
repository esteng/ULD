...
def main():
    ...
    group.add_argument('--delay', type=int, default=20,
                       help='number of seconds to wait for the server to start (20)')
    ...
    with amdtk.parallel(args.profile, args.njobs, args.delay) as dview:

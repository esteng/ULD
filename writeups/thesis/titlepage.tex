...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\large Submitted in partial fulfillment of the requirements for the degree of \\
	...
	{\large October 12, 2017} % Date, change the \today to a set date if you want to be precise

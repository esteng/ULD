...
\myrule{
	\toprulecomp{i}{s}{A}{a}{E\in\{IB,SUB\}}{m}{P}
	}
	{
	\botrulecomp{i+1}{s}{A}{a}{E}{m}{P'= P \cdot p_{hmm}(s \rightarrow s) \cdot lh(A,s,i+1)}
	}
	
\subsubsection{PLU-internal HMM state transition}

\myrule{
	\toprulecomp{i}{s\in\{start,mid\}}{A}{a}{E\in\{IB,SUB\}}{m}{P}
	}
	{
	\botrulecomp{i+1}{s+1}{A}{a}{E}{m}{P'= P \cdot p_{hmm}(s \rightarrow s+1) \cdot lh(A,s+1,i+1)}
	}
...
\noindent\begin{tabular}{ l p{4.1cm} l }
  ...
  \toprulecomp{i-1}{end}{B}{a-1}{E'}{m-1}{P'} & if $E=SUB$,\hfill$s=start$ & Substitute operation \\
  \toprulecomp{i-1}{s}{A}{a}{E}{m}{P'} & if $E\in\{IB,SUB\}$ & PLU-internal HMM self-transition \\
  \toprulecomp{i-1}{s-1}{A}{a}{E}{m}{P'} & if $E\in\{IB,SUB\},s\in\{mid,end\}$ & PLU-internal HMM transition \\
\end{tabular}
